...
// 生成唯一编号
function generateNo(prefix, index) {
  const date = new Date();
...
const mockData = {
  // 1. 客户管理 - 10条
  customers: [
    { customer_code: 'CUST20240001', customer_name: '深圳市科技有限公司', short_name: '深圳科技', customer_type: 1, contact_name: '张经理', contact_phone: '13800138001', email: 'zhang@sztech.com', address: '深圳市南山区科技园', status: 1 },
    { customer_code: 'CUST20240002', customer_name: '广州贸易发展有限公司', short_name: '广州贸易', customer_type: 1, contact_name: '李主任', contact_phone: '13800138002', email: 'li@gtrade.com', address: '广州市天河区珠江新城', status: 1 },
    { customer_code: 'CUST20240003', customer_name: '东莞制造有限公司', short_name: '东莞制造', customer_type: 1, contact_name: '王总', contact_phone: '13800138003', email: 'wang@dgmake.com', address: '东莞市长安镇工业区', status: 1 },
    { customer_code: 'CUST20240004', customer_name: '佛山实业集团有限公司', short_name: '佛山实业', customer_type: 1, contact_name: '陈经理', contact_phone: '13800138004', email: 'chen@fsind.com', address: '佛山市顺德区北滘镇', status: 1 },
    { customer_code: 'CUST20240005', customer_name: '中山电子科技有限公司', short_name: '中山电子', customer_type: 1, contact_name: '刘主任', contact_phone: '13800138005', email: 'liu@zselec.com', address: '中山市火炬开发区', status: 1 },
    { customer_code: 'CUST20240006', customer_name: '惠州包装材料有限公司', short_name: '惠州包装', customer_type: 1, contact_name: '赵经理', contact_phone: '13800138006', email: 'zhao@hzpack.com', address: '惠州市惠城区', status: 1 },
    { customer_code: 'CUST20240007', customer_name: '珠海进出口贸易有限公司', short_name: '珠海进出口', customer_type: 1, contact_name: '孙总', contact_phone: '13800138007', email: 'sun@zhimport.com', address: '珠海市香洲区', status: 1 },
    { customer_code: 'CUST20240008', customer_name: '江门印刷包装有限公司', short_name: '江门印刷', customer_type: 1, contact_name: '周经理', contact_phone: '13800138008', email: 'zhou@jmprint.com', address: '江门市蓬江区', status: 1 },
    { customer_code: 'CUST20240009', customer_name: '肇庆新材料科技有限公司', short_name: '肇庆新材料', customer_type: 1, contact_name: '吴主任', contact_phone: '13800138009', email: 'wu@zqmaterial.com', address: '肇庆市端州区', status: 1 },
    { customer_code: 'CUST20240010', customer_name: '汕头塑料制品有限公司', short_name: '汕头塑料', customer_type: 1, contact_name: '郑经理', contact_phone: '13800138010', email: 'zheng@stplastic.com', address: '汕头市龙湖区', status: 1 }
  ],

  // 2. 采购申请 - 10条
  purchaseRequests: [
    { request_no: 'PR202403001', request_date: '2024-03-01', requester_id: 1, requester_name: '张三', department: '生产部', total_amount: 50000.00, status: 3, remark: 'PET透明膜采购申请', create_by: 1 },
    { request_no: 'PR202403002', request_date: '2024-03-02', requester_id: 2, requester_name: '李四', department: '品质部', total_amount: 30000.00, status: 3, remark: '防静电膜采购申请', create_by: 2 },
    { request_no: 'PR202403003', request_date: '2024-03-05', requester_id: 1, requester_name: '张三', department: '生产部', total_amount: 80000.00, status: 3, remark: '标签纸大批量采购', create_by: 1 },
    { request_no: 'PR202403004', request_date: '2024-03-08', requester_id: 3, requester_name: '王五', department: '采购部', total_amount: 45000.00, status: 2, remark: '彩印膜采购申请', create_by: 3 },
    { request_no: 'PR202403005', request_date: '2024-03-10', requester_id: 1, requester_name: '张三', department: '生产部', total_amount: 25000.00, status: 3, remark: '热收缩膜紧急采购', create_by: 1 },
    { request_no: 'PR202403006', request_date: '2024-03-12', requester_id: 4, requester_name: '赵六', department: '仓库部', total_amount: 15000.00, status: 3, remark: '保护膜采购申请', create_by: 4 },
    { request_no: 'PR202403007', request_date: '2024-03-15', requester_id: 1, requester_name: '张三', department: '生产部', total_amount: 100000.00, status: 1, remark: '复合膜大批量采购', create_by: 1 },
    { request_no: 'PR202403008', request_date: '2024-03-18', requester_id: 2, requester_name: '李四', department: '品质部', total_amount: 35000.00, status: 2, remark: '检测耗材采购', create_by: 2 },
    { request_no: 'PR202403009', request_date: '2024-03-20', requester_id: 5, requester_name: '孙七', department: '销售部', total_amount: 60000.00, status: 1, remark: '样品材料采购', create_by: 5 },
    { request_no: 'PR202403010', request_date: '2024-03-25', requester_id: 1, requester_name: '张三', department: '生产部', total_amount: 75000.00, status: 1, remark: '常规物料补货', create_by: 1 }
  ],

  // 3. 仓库 - 5个
  warehouses: [
    { warehouse_code: 'WH001', warehouse_name: '原材料仓', warehouse_type: 1, location: 'A区1楼', manager: '赵六', status: 1 },
    { warehouse_code: 'WH002', warehouse_name: '半成品仓', warehouse_type: 2, location: 'A区2楼', manager: '钱八', status: 1 },
    { warehouse_code: 'WH003', warehouse_name: '成品仓', warehouse_type: 3, location: 'B区1楼', manager: '孙九', status: 1 },
    { warehouse_code: 'WH004', warehouse_name: '辅料仓', warehouse_type: 4, location: 'B区2楼', manager: '周十', status: 1 },
    { warehouse_code: 'WH005', warehouse_name: '不良品仓', warehouse_type: 5, location: 'C区1楼', manager: '吴十一', status: 1 }
  ],
...
async function insertData() {
  ...
  try {
    ...
    for (const cust of mockData.customers) {
      try {
        await connection.execute(
          `INSERT INTO crm_customer (customer_code, customer_name, short_name, customer_type, contact_name, contact_phone, email, address, status, create_time) 
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())`,
          [cust.customer_code, cust.customer_name, cust.short_name, cust.customer_type, cust.contact_name, cust.contact_phone, cust.email, cust.address, cust.status]
        );
        results.customers++;
      } catch (err) {
    ...
    for (const pr of mockData.purchaseRequests) {
      try {
        await connection.execute(
          `INSERT INTO pur_request (request_no, request_date, requester_id, requester_name, department, total_amount, status, remark, create_by, create_time) 
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())`,
          [pr.request_no, pr.request_date, pr.requester_id, pr.requester_name, pr.department, pr.total_amount, pr.status, pr.remark, pr.create_by]
        );
    ...
    for (const wh of mockData.warehouses) {
      try {
        await connection.execute(
          `INSERT INTO inv_warehouse (warehouse_code, warehouse_name, warehouse_type, location, manager, status, create_time) 
           VALUES (?, ?, ?, ?, ?, ?, NOW())`,
          [wh.warehouse_code, wh.warehouse_name, wh.warehouse_type, wh.location, wh.manager, wh.status]
        );
        results.warehouses++;
      } catch (err) {
        if (err.code === 'ER_DUP_ENTRY') {
