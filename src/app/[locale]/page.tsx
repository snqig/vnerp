          ...
          <div className="tech-title-wrapper">
            <div className="tech-title-row">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-white/50 mt-0.5">{t('enterpriseMonitor')}</p>
              </div>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            {recentOrders.length === 0 ? (
              <p className="text-white/40 text-center py-8">{t('noOrderData')}</p>
            ) : (
          ...
          >
            <h3 className="text-sm font-semibold text-cyan-300 mb-4 flex items-center gap-2">
              ...
              {t('recentWorkOrderList')}
            </h3>
            {recentWorkOrders.length === 0 ? (
              <p className="text-white/40 text-center py-8">{t('noWorkOrderData')}</p>
            ) : (
              <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center justify-between space-x-4">
              <div className="space-y-1">
                <p className="text-sm font-medium text-white/60">{t('pendingOrders')}</p>
            ...
            <div className="flex items-center justify-between space-x-4">
              <div className="space-y-1">
                <p className="text-sm font-medium text-white/60">{t('inProduction')}</p>
            ...
            <div className="flex items-center justify-between space-x-4">
              <div className="space-y-1">
                <p className="text-sm font-medium text-white/60">{t('completed')}</p>
