...
export const GET = withPermission(async (request: NextRequest, _userInfo) => {
  ...
  const totalRows = await query('SELECT COUNT(*) as total FROM qms_complaint ' + where, params);
...
export const PUT = withPermission(
  async (request: NextRequest, _userInfo) => {
    ...
    if (defect_date !== undefined) {
      fields.push('defect_date = ?');
      values.push(defect_date);
    }
    if (defect_qty !== undefined) {
      fields.push('defect_qty = ?');
      values.push(defect_qty);
    }
    if (defect_desc !== undefined) {
    ...
    if (d1_team !== undefined) {
      fields.push('d1_team = ?');
      values.push(d1_team);
    }
    if (d2_desc !== undefined) {
      fields.push('d2_desc = ?');
      values.push(d2_desc);
    }
    if (d3_interim_action !== undefined) {
      fields.push('d3_interim_action = ?');
      values.push(d3_interim_action);
    }
    if (d4_root_cause !== undefined) {
      fields.push('d4_root_cause = ?');
      values.push(d4_root_cause);
    }
    if (d5_corrective_action !== undefined) {
      fields.push('d5_corrective_action = ?');
      values.push(d5_corrective_action);
    }
    if (d6_implement_verify !== undefined) {
      fields.push('d6_implement_verify = ?');
      values.push(d6_implement_verify);
    }
    if (d7_preventive_action !== undefined) {
      fields.push('d7_preventive_action = ?');
      values.push(d7_preventive_action);
    }
    if (d8_congratulations !== undefined) {
      fields.push('d8_congratulations = ?');
      values.push(d8_congratulations);
    }
    if (d1_date !== undefined) {
      fields.push('d1_date = ?');
      values.push(d1_date);
    }
    if (d2_date !== undefined) {
      fields.push('d2_date = ?');
      values.push(d2_date);
    }
    if (d3_date !== undefined) {
      fields.push('d3_date = ?');
      values.push(d3_date);
    }
    if (d4_date !== undefined) {
      fields.push('d4_date = ?');
      values.push(d4_date);
    }
    if (d5_date !== undefined) {
      fields.push('d5_date = ?');
      values.push(d5_date);
    }
    if (d6_date !== undefined) {
      fields.push('d6_date = ?');
      values.push(d6_date);
    }
    if (d7_date !== undefined) {
      fields.push('d7_date = ?');
      values.push(d7_date);
    }
    if (d8_date !== undefined) {
      fields.push('d8_date = ?');
      values.push(d8_date);
    }
    if (status !== undefined) {
