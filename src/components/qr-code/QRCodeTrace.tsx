                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm">
                          ...
                          <Badge variant="outline" className="mt-1">
                            {typeMap[traceData.record?.qr_type as string] ||
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-sm">
                        ...
                        <Badge variant="outline">
                          {typeMap[traceData.record.qr_type as string] || traceData.record.qr_type}
                        </Badge>
                      </div>
                      <div className="text-sm">
                        <span className="text-muted-foreground">{tc('status')}：</span>
                        <Badge variant={statusMap[traceData.record.status as number]?.variant}>
                          {statusMap[traceData.record.status as number]?.label}
                        </Badge>
                      </div>
                      <div className="text-sm">
                    ...
                    <TableBody>
                      {traceData.related_records.map((record, i) => (
                        <TableRow key={i}>
                          ...
                          <TableCell>
                            <Badge variant="outline">
                              {typeMap[record.qr_type as string] || record.qr_type}
                            </Badge>
                          </TableCell>
                          ...
                          <TableCell>
                            <Badge variant={statusMap[record.status as number]?.variant}>
                              {statusMap[record.status as number]?.label}
                            </Badge>
                          </TableCell>
                        </TableRow>
                      ))}
