...
export const standardCardStateMachine: Record<StandardCardStatus, {
...
export const statusTransitionActions: StateTransition[] = [
  { from: StandardCardStatus.DRAFT, to: StandardCardStatus.AUDITING, action: 'submit', requiredRole: ['process_engineer', 'admin'] },
  { from: StandardCardStatus.AUDITING, to: StandardCardStatus.APPROVED, action: 'approve', requiredRole: ['process_manager', 'admin'] },
  { from: StandardCardStatus.AUDITING, to: StandardCardStatus.DRAFT, action: 'reject', requiredRole: ['process_manager', 'admin'] },
  { from: StandardCardStatus.APPROVED, to: StandardCardStatus.CONFIRMED, action: 'confirm', requiredRole: ['general_manager', 'admin'] },
  { from: StandardCardStatus.APPROVED, to: StandardCardStatus.OBSOLETE, action: 'obsolete', requiredRole: ['process_manager', 'admin'] },
  { from: StandardCardStatus.CONFIRMED, to: StandardCardStatus.OBSOLETE, action: 'obsolete', requiredRole: ['process_manager', 'admin'] }
];
