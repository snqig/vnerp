...
export function getTypePrefix(type: StandardCardType): string {
  switch (type) {
    case StandardCardType.COLOR: return 'SCC';
    case StandardCardType.PROCESS: return 'SCP';
    case StandardCardType.QUALITY: return 'SCQ';
    case StandardCardType.COMPREHENSIVE: return 'SCZ';
    default: return 'SC';
  }
}
