...
> = {
  ...
  '/api/system/config': { GET: API_PERMISSIONS.SYSTEM_CONFIG, PUT: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG, DELETE: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/dict': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG, PUT: API_PERMISSIONS.SYSTEM_CONFIG, DELETE: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/dict-type': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_DICT_TYPE_MANAGE, PUT: API_PERMISSIONS.SYSTEM_DICT_TYPE_MANAGE, DELETE: API_PERMISSIONS.SYSTEM_DICT_TYPE_MANAGE },
  '/api/system/dict-data': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_DICT_DATA_MANAGE, PUT: API_PERMISSIONS.SYSTEM_DICT_DATA_MANAGE, DELETE: API_PERMISSIONS.SYSTEM_DICT_DATA_MANAGE },
  '/api/system/data-scope': { GET: API_PERMISSIONS.SYSTEM_ROLE, PUT: API_PERMISSIONS.SYSTEM_ROLE },
  '/api/system/announcement': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG, PUT: API_PERMISSIONS.SYSTEM_CONFIG, DELETE: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/notice': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG, PUT: API_PERMISSIONS.SYSTEM_CONFIG, DELETE: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/scheduler': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG, PUT: API_PERMISSIONS.SYSTEM_CONFIG, DELETE: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/workflow': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG, PUT: API_PERMISSIONS.SYSTEM_CONFIG, DELETE: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/monitor': { GET: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/outbox': { GET: API_PERMISSIONS.SYSTEM_CONFIG },
  '/api/system/data-fix': { GET: API_PERMISSIONS.SYSTEM_CONFIG, POST: API_PERMISSIONS.SYSTEM_CONFIG },
