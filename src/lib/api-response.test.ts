...
describe('API响应工具测试', () => {
  ...
  describe('validateRequestBody - 请求体验证', () => {
    ...
    it('应该通过完整数据', () => {
      const result = validateRequestBody({ name: 'John', email: 'john@example.com' }, [
        'name',
        'email',
      ]);
    ...
    it('应该检测空字符串', () => {
      const result = validateRequestBody({ name: '', email: 'john@example.com' }, [
        'name',
        'email',
      ]);
      expect(result.valid).toBe(false);
    ...
    it('应该检测null值', () => {
      const result = validateRequestBody({ name: null, email: 'john@example.com' }, [
        'name',
        'email',
      ]);
      expect(result.valid).toBe(false);
    ...
    it('应该检测undefined值', () => {
      const result = validateRequestBody({ name: undefined, email: 'john@example.com' }, [
        'name',
        'email',
      ]);
      expect(result.valid).toBe(false);
