/**
 * src/app/api/auth/login/route.ts 使用的 SQL 常量。
 *
...
/** INSERT … */
export const INSERT_INTO_SYS_NOTIFICATION = `INSERT INTO sys_notification (type, title, content, user_id, is_read, create_time)
