/**
 * src/app/api/dcprint/ink-init/route.ts 使用的 SQL 常量。
 *
...
/** ALTER */
export const ALTER_TABLE_INK_OPENING_RECORD = `ALTER TABLE ink_opening_record ADD COLUMN workorder_id BIGINT UNSIGNED COMMENT '工单ID' AFTER remark`;

/** CREATE … */
export const CREATE_TABLE_INK_DISPATCH_ITEM = `
...
/** CREATE … */
export const CREATE_TABLE_INK_FORMULA_WORKORDER = `
...
/** ALTER */
export const ALTER_TABLE_INV_INVENTORY_BATCH = `ALTER TABLE inv_inventory_batch ADD COLUMN inspection_id BIGINT UNSIGNED COMMENT '检验记录ID' AFTER status`;

/** ALTER */
export const ALTER_TABLE_INK_OPENING_RECORD_2 = `ALTER TABLE ink_opening_record ADD COLUMN workorder_no VARCHAR(50) COMMENT '工单号' AFTER workorder_id`;

/** CREATE … */
export const CREATE_TABLE_INK_DISPATCH = `
...
/** CREATE … */
export const CREATE_TABLE_INK_FORMULA_ITEM = `
...
/** CREATE … */
export const CREATE_TABLE_INK_FORMULA = `
...
/** ALTER */
export const ALTER_TABLE_INV_SCAN_LOG = `ALTER TABLE inv_scan_log ADD COLUMN batch_no VARCHAR(50) COMMENT '批次号' AFTER sn`;
