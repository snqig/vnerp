/**
 * src/app/api/init/po-grn-tables/route.ts 使用的 SQL 常量。
 *
...
/** CREATE … */
export const CREATE_TABLE_PUR_SUPPLIER = `
...
/** CREATE … */
export const CREATE_TABLE_PUR_PURCHASE_ORDER = `
...
/** INSERT … */
export const INSERT_INTO_PUR_PURCHASE_ORDER_LINE = `
...
/** CREATE … */
export const CREATE_TABLE_PUR_PURCHASE_ORDER_LINE = `
...
/** INSERT … */
export const INSERT_INTO_PUR_PURCHASE_ORDER = `
...
/** INSERT … */
export const INSERT_INTO_PUR_SUPPLIER = `
...
/** CREATE … */
export const CREATE_TABLE_INV_INVENTORY_TRANSACTION = `
...
/** INSERT … */
export const INSERT_INTO_PUR_PURCHASE_ORDER_LINE_2 = `
        INSERT INTO pur_purchase_order_line 
        (po_id, line_no, material_code, material_name, material_spec, unit, order_qty, unit_price, amount, require_date)
        SELECT 
...
/** CREATE … */
export const CREATE_TABLE_PUR_RETURN_ORDER = `
