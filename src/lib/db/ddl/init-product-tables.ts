/**
 * src/app/api/init/product-tables/route.ts 使用的 SQL 常量。
 *
...
/** CREATE … */
export const CREATE_TABLE_MDM_PRODUCT = `
...
/** INSERT … */
export const INSERT_INTO_MDM_PRODUCT_CATEGORY = `
...
/** INSERT … */
export const INSERT_INTO_MDM_PRODUCT = `
...
/** CREATE … */
export const CREATE_TABLE_MDM_PRODUCT_ROUTE = `
...
/** CREATE … */
export const CREATE_TABLE_MDM_PRODUCT_BOM = `
...
/** CREATE … */
export const CREATE_TABLE_MDM_PRODUCT_CATEGORY = `
