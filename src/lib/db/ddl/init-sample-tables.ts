/**
 * src/app/api/init/sample-tables/route.ts 使用的 SQL 常量。
 *
...
/** CREATE … */
export const CREATE_TABLE_SAL_SAMPLE_ORDER_HISTORY = `
...
/** CREATE … */
export const CREATE_TABLE_SAL_SAMPLE_ORDER = `
...
/** INSERT … */
export const INSERT_INTO_SAL_SAMPLE_ORDER = `
