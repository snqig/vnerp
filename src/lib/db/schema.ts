...
// 仓库主数据
export const invWarehouse = mysqlTable('inv_warehouse', {
  id: serial('id').primaryKey(),
...
// 库存表
export const invInventory = mysqlTable('inv_inventory', {
  id: serial('id').primaryKey(),
  ...
  materialWarehouseIdx: uniqueIndex('uk_material_warehouse').on(table.materialId, table.warehouseId),
  materialIdx: index('idx_material').on(table.materialId),
  warehouseIdx: index('idx_warehouse').on(table.warehouseId),
...
// 出库单主表
export const invOutboundOrders = mysqlTable('inv_outbound_order', {
  id: serial('id').primaryKey(),
...
// 出库单明细
export const invOutboundItems = mysqlTable('inv_outbound_item', {
  id: serial('id').primaryKey(),
  orderId: bigint('order_id', { mode: 'number', unsigned: true }).notNull(),
  materialId: bigint('material_id', { mode: 'number', unsigned: true }).notNull(),
  materialName: varchar('material_name', { length: 100 }),
...
// 调拨单主表
export const invTransferOrders = mysqlTable('inv_transfer_order', {
  id: serial('id').primaryKey(),
...
// 盘点单主表
export const invStocktaking = mysqlTable('inv_stocktaking', {
  id: serial('id').primaryKey(),
...
// 销售订单主表
export const salOrder = mysqlTable('sal_order', {
  id: serial('id').primaryKey(),
  orderNo: varchar('order_no', { length: 50 }).notNull(),
  orderDate: date('order_date'),
...
// 销售订单明细
export const salOrderDetail = mysqlTable('sal_order_detail', {
  id: serial('id').primaryKey(),
  orderId: bigint('order_id', { mode: 'number', unsigned: true }).notNull(),
  materialId: bigint('material_id', { mode: 'number', unsigned: true }).notNull(),
  materialName: varchar('material_name', { length: 100 }),
...
// 销售出库单
export const salDelivery = mysqlTable('sal_delivery', {
  id: serial('id').primaryKey(),
...
// 销售退货单
export const salReturnOrder = mysqlTable('sal_return_order', {
  id: serial('id').primaryKey(),
...
// 销售对账单
export const salReconciliation = mysqlTable('sal_reconciliation', {
  id: serial('id').primaryKey(),
...
// 采购订单主表
export const purPurchaseOrder = mysqlTable('pur_purchase_order', {
  ...
  overReceiptTolerance: decimal('over_receipt_tolerance', { precision: 18, scale: 4 }).default('5.0000'),
  paymentTerms: varchar('payment_terms', { length: 100 }),
...
// 采购订单行
export const purPurchaseOrderLine = mysqlTable('pur_purchase_order_line', {
  id: serial('id').primaryKey(),
...
// 采购退货单
export const purPurchaseReturn = mysqlTable('pur_purchase_return', {
  id: bigint('id', { mode: 'number', unsigned: true }).autoincrement().primaryKey(),
...
// 采购对账单
export const purPurchaseReconciliation = mysqlTable('pur_purchase_reconciliation', {
  id: bigint('id', { mode: 'number', unsigned: true }).autoincrement().primaryKey(),
...
// 应收账款
export const finReceivable = mysqlTable('fin_receivable', {
  id: serial('id').primaryKey(),
...
// 应付账款
export const finPayable = mysqlTable('fin_payable', {
  id: serial('id').primaryKey(),
...
// 生产工单
export const prdWorkOrder = mysqlTable('prd_work_order', {
  id: serial('id').primaryKey(),
