...
export const sampleProcessTemplateItem = mysqlTable(
  ...
  (table) => ({
    ...
    fk_dcprintSampleProcessTemplate_templateId: foreignKey({
      name: 'fk_tpl_item_card',
      columns: [table.templateId],
      foreignColumns: [sampleProcessTemplate.id],
    })
      .onDelete('cascade')
      .onUpdate('cascade'),
  })
...
export const sampleProcessTemplateStep = mysqlTable(
  ...
  (table) => ({
    templateIdIdx: index('idx_spt_step_template').on(table.templateId),
      fk_sampleProcessTemplate_templateId: foreignKey({
      name: 'fk_tpl_step_card',
      columns: [table.templateId],
      foreignColumns: [sampleProcessTemplate.id],
    })
      .onDelete('cascade')
