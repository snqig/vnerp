...
function getConfigFromCache(): Record<string, unknown> | null {
...
function setConfigToCache(data: Record<string, unknown>): void {
  configCache = {
    data,
    timestamp: Date.now(),
  };
...
export function setConfig(configs: Record<string, unknown>): void {
