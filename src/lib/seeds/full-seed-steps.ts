...
export async function seedMasterData(conn: Loose, stats: Record<string, number>): Promise<Loose[]> {
  const warehouses = [
...
export async function seedCommercialData(
...
): Promise<{ saleOrderIds: number[]; purchaseOrders: Loose[]; deliveryOrders: Loose[]; salesOrders: Loose[] }> {
  const salesOrders = [
    {
      no: 'SO20260401001',
      cid: 1,
  ...
  for (const order of salesOrders) {
    ...
    for (const item of order.items) {
      ...
      await conn.execute(
        ...
        [orderId, mat?.material_name || '', item.qty, mat?.unit || '个', item.price, amount]
      );
    }
  }
  ...
  const deliveryOrders = [
    ...
    },
    {
      ...
      date: '2026-04-20',
      items: [
        { mid: 13, name: '手机电池标签', spec: '50×30mm', qty: 150000, unit: '张', price: 0.45 },
      ],
      sign: 0,
      status: 2,
    },
    {
      ...
      date: '2026-04-22',
      items: [
        { mid: 14, name: '新能源电池标签', spec: '150×80mm', qty: 70000, unit: '张', price: 5.5 },
      ],
      sign: 0,
      status: 2,
    },
    {
      ...
      date: '2026-04-16',
      items: [
        { mid: 15, name: '医疗设备面板', spec: '200×150mm', qty: 19800, unit: '张', price: 7.8 },
      ],
      sign: 1,
      status: 3,
    },
    {
      ...
      date: '2026-04-17',
      items: [
        { mid: 16, name: '工业设备铭牌', spec: '100×60mm', qty: 97800, unit: '张', price: 1.35 },
      ],
      sign: 1,
      status: 3,
    },
    ...
    },
    {
      ...
      date: '2026-04-25',
      items: [
        { mid: 18, name: '电池防伪标签', spec: '80×50mm', qty: 140000, unit: '张', price: 0.95 },
      ],
      sign: 0,
      status: 1,
    },
    ...
    },
    {
      ...
      date: '2026-04-28',
      items: [
        { mid: 20, name: '智能家居面板', spec: '150×100mm', qty: 55000, unit: '张', price: 3.2 },
      ],
      sign: 0,
      status: 1,
    },
  ...
  const returnOrders = [
    ...
    },
    {
      ...
      date: '2026-04-18',
      type: 3,
      reason: '丝印套位偏差，与图纸要求不符',
      items: [
        { mid: 15, name: '医疗设备面板', spec: '200×150mm', qty: 500, unit: '张', price: 7.8 },
      ],
    },
  ];
...
export async function seedProductionData(
  ...
  const bomList = [
    {
      ...
      pid: 11,
      items: [
        { mid: 1, qty: 55000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 12,
      items: [
        { mid: 2, qty: 33000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 13,
      items: [
        { mid: 3, qty: 220000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 14,
      items: [
        { mid: 3, qty: 88000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 15,
      items: [
        { mid: 1, qty: 22000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 16,
      items: [
        { mid: 1, qty: 110000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 19,
      items: [
        { mid: 2, qty: 44000, unit: '张', loss: 10 },
    ...
    },
    {
      ...
      pid: 20,
      items: [
        { mid: 2, qty: 66000, unit: '张', loss: 10 },
  ...
  for (const wr of workReports) {
    await conn.execute(
      `INSERT INTO prd_work_report (report_no, work_order_id, work_order_no, process_name, process_seq, equipment_id, operator_name, plan_qty, completed_qty, qualified_qty, defective_qty, scrap_qty, start_time, end_time, work_hours, is_first_piece, first_piece_status, first_piece_inspector, remark, create_time) VALUES (?, ?, ?, ?, ?, ?, '张师傅', ?, ?, ?, ?, 0, ?, ?, 8, ?, ?, '李质检', '', NOW())`,
      [
        wr.no,
        wr.woid || 1,
        wr.wono,
...
export async function seedInventoryData(
  conn: Loose,
  stats: Record<string, number>,
  _purchaseOrders: Loose[]
) {
  const inboundOrders = [
    {
      no: 'IN20260408001',
      supplier: '东莞PET薄膜有限公司',
      date: '2026-04-08',
      wh: 1,
      poId: 1,
      poNo: 'PO20260401001',
  ...
  const inventoryData = [
    ...
    { mid: 8, name: '导电银浆', wh: 4, whname: '油墨辅料仓', qty: 8, cost: 850.0, unit: 'kg' },
    { mid: 9, name: 'UV光油', wh: 4, whname: '油墨辅料仓', qty: 38, cost: 120.0, unit: 'kg' },
    {
      mid: 10,
      name: '网版感光胶',
      wh: 4,
...
export async function seedQualityData(conn: Loose, stats: Record<string, number>) {
  const inspections = [
    {
      no: 'QI20260408001',
      type: 1,
...
export async function seedFinancialData(conn: Loose, stats: Record<string, number>, deliveryOrders: Loose[]) {
  ...
  for (const rc of reconciliations) {
    ...
    const dnList = deliveryOrders.filter((d: Loose) => d.cid === rc.cid);
...
export async function seedMaintenanceData(conn: Loose, stats: Record<string, number>) {
  const maintenancePlans = [
    {
      ...
      cycleValue: 1,
      planDate: '2026-05-01',
      content: '检查丝印刮刀磨损、清洁网版夹具、校准定位系统',
    },
    {
      no: 'MP20260401002',
      eqId: 2,
    ...
    },
    {
      ...
      cycleValue: 1,
      planDate: '2026-05-01',
      content: '检查传送带张力、清洁IR加热管、校准温控系统',
    },
    {
      no: 'MP20260401006',
      eqId: 7,
      ...
      cycleValue: 1,
      planDate: '2026-05-01',
      content: '检查模切刀模磨损、校准模切压力、清洁送料系统',
    },
    {
      no: 'MP20260401007',
      eqId: 9,
...
export async function seedContactsAndLocations(conn: Loose, stats: Record<string, number>) {
  const locations = [
